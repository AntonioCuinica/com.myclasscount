 ...
 * @author CUINIC4
 */
public class verObservacoes extends JFrame {
    ...
    public verObservacoes(JFrame anterior){
        ...
        title=myProcedures.barName("Lista de Observaçoes",this);
        container.add(title);
        this.addTable();
            ...
            new MouseAdapter(){
                public void mouseClicked(MouseEvent evento){
                    if(evento.getClickCount()==2){
                        ...
                        if(tabela.getSelectedColumn()==4){myDialog dialog=new myDialog(frame,true);}
                    }
                }
            }
        );
